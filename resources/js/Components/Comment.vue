    ...
    <div>
        ...
        <form v-if="editing" @submit.prevent="submitCommentUpdateForm">
            <textarea v-model="form.comment"
                      class="mt-4 w-full h-64 text-gray-900 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"/>
        ...
        <p v-else class="mt-2">{{ comment.comment }}</p>
    </div>
</template>
